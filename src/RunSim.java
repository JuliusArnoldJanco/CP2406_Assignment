...
public class RunSim {
    ...
    int TL12Condition = randomGenerator.nextInt(3) + 1;
        ...
        for(int i =0; i<DP.getGridIcons().length;i++) {
            ...
            if (DP.getCond(i) == 3) {
                ...
                if (i == 0){
                    ...
                    if (TLCondition == 1){TL3.setTrafficLightCondition(3);TL4.setTrafficLightCondition(3);}
                    else if (TLCondition == 2){TL3.setTrafficLightCondition(1);TL4.setTrafficLightCondition(1);}
                    else{TL3.setTrafficLightCondition(1);TL4.setTrafficLightCondition(1);}
                    ...
                    lpane.add(TL4, new Integer(1), 0);
                        ...
                        if (TL2Condition == 1){TL7.setTrafficLightCondition(3);TL8.setTrafficLightCondition(3);}
                        else if (TL2Condition == 2){TL7.setTrafficLightCondition(1);TL8.setTrafficLightCondition(1);}
                        else{TL7.setTrafficLightCondition(1);TL8.setTrafficLightCondition(1);}
                        ...
                        if (TL3Condition == 1){TL11.setTrafficLightCondition(3);TL12.setTrafficLightCondition(3);}
                        else if (TL3Condition == 2){TL11.setTrafficLightCondition(1);TL12.setTrafficLightCondition(1);}
                        else{TL11.setTrafficLightCondition(1);TL12.setTrafficLightCondition(1);}
                        ...
                        if (TL4Condition == 1){TL15.setTrafficLightCondition(3);TL16.setTrafficLightCondition(3);}
                        else if (TL4Condition == 2){TL15.setTrafficLightCondition(1);TL16.setTrafficLightCondition(1);}
                        else{TL15.setTrafficLightCondition(1);TL16.setTrafficLightCondition(1);}
                        ...
                        if (TL5Condition == 1){TL19.setTrafficLightCondition(3);TL20.setTrafficLightCondition(3);}
                        else if (TL5Condition == 2){TL19.setTrafficLightCondition(1);TL20.setTrafficLightCondition(1);}
                        else{TL19.setTrafficLightCondition(1);TL20.setTrafficLightCondition(1);}
                        ...
                        if (TL6Condition == 1){TL23.setTrafficLightCondition(3);TL24.setTrafficLightCondition(3);}
                        else if (TL6Condition == 2){TL23.setTrafficLightCondition(1);TL24.setTrafficLightCondition(1);}
                        else{TL23.setTrafficLightCondition(1);TL24.setTrafficLightCondition(1);}
                        ...
                        if (TL7Condition == 1){TL27.setTrafficLightCondition(3);TL28.setTrafficLightCondition(3);}
                        else if (TL7Condition == 2){TL27.setTrafficLightCondition(1);TL28.setTrafficLightCondition(1);}
                        else{TL27.setTrafficLightCondition(1);TL28.setTrafficLightCondition(1);}
                    ...
                    if (TL8Condition == 1){TL31.setTrafficLightCondition(3);TL32.setTrafficLightCondition(3);}
                    else if (TL8Condition == 2){TL31.setTrafficLightCondition(1);TL32.setTrafficLightCondition(1);}
                    else{TL31.setTrafficLightCondition(1);TL32.setTrafficLightCondition(1);}
                    ...
                    lpane.add(TL32, new Integer(1), 0);
                        ...
                        if (TL9Condition == 1){TL35.setTrafficLightCondition(3);TL36.setTrafficLightCondition(3);}
                        else if (TL9Condition == 2){TL35.setTrafficLightCondition(1);TL36.setTrafficLightCondition(1);}
                        else{TL35.setTrafficLightCondition(1);TL36.setTrafficLightCondition(1);}
                ...
                if (i == 0) {
                    ...
                    if (TL10Condition == 1){TL4.setTrafficLightCondition(3);}
                    else if (TL10Condition == 2){TL4.setTrafficLightCondition(1);}
                    else{TL4.setTrafficLightCondition(1);}
                    TL4.setBounds(290 - 210, 140, 20, 50);
                    lpane.add(TL, new Integer(1), 0);
                    lpane.add(TL2, new Integer(1), 0);
                    lpane.add(TL3, new Integer(1), 0);
                    lpane.add(TL4, new Integer(1), 0);
                        ...
                        if (TL11Condition == 1){TL8.setTrafficLightCondition(3);}
                        else if (TL11Condition == 2){TL8.setTrafficLightCondition(1);}
                        else{TL8.setTrafficLightCondition(1);}
                        TL8.setBounds(290, 140, 20, 50);
                        lpane.add(TL5, new Integer(1), 0);
                        lpane.add(TL6, new Integer(1), 0);
                        lpane.add(TL7, new Integer(1), 0);
                        ...
                        if (TL13Condition == 1){TL12.setTrafficLightCondition(3);}
                        else if (TL13Condition == 2){TL12.setTrafficLightCondition(1);}
                        else{TL12.setTrafficLightCondition(1);}
                        //TL11.setBounds(290+210, 0, 20, 50);
                        TL12.setBounds(290+210, 140, 20, 50);
                        lpane.add(TL9, new Integer(1), 0);
                        lpane.add(TL10, new Integer(1), 0);
                        ...
                        if (TL14Condition == 1){TL16.setTrafficLightCondition(3);}
                        else if (TL14Condition == 2){TL16.setTrafficLightCondition(1);}
                        else{TL16.setTrafficLightCondition(1);}
                        //TL15.setBounds(290-210, 205, 20, 50);
                        TL16.setBounds(290-210, 330, 20, 50);
                        ...
                        if (TL15Condition == 1){TL20.setTrafficLightCondition(3);}
                        else if (TL15Condition == 2){TL20.setTrafficLightCondition(1);}
                        else{TL20.setTrafficLightCondition(1);}
                        //TL19.setBounds(290, 205, 20, 50);
                        TL20.setBounds(290, 330, 20, 50);
                        lpane.add(TL17, new Integer(1), 0);
                        lpane.add(TL18, new Integer(1), 0);
                        ...
                        if (TL16Condition == 1){TL24.setTrafficLightCondition(3);}
                        else if (TL16Condition == 2){TL24.setTrafficLightCondition(1);}
                        else{TL23.setTrafficLightCondition(1);TL24.setTrafficLightCondition(1);}
                        TL24.setBounds(290+210, 330, 20, 50);
                        lpane.add(TL21, new Integer(1), 0);
                        lpane.add(TL22, new Integer(1), 0);
                        ...
                        if (TL17Condition == 1){TL28.setTrafficLightCondition(3);}
                        else if (TL17Condition == 2){TL28.setTrafficLightCondition(1);}
                        else{TL28.setTrafficLightCondition(1);}
                        TL28.setBounds(290-210, 330+210, 20, 50);
                        lpane.add(TL25, new Integer(1), 0);
                        lpane.add(TL26, new Integer(1), 0);
                        lpane.add(TL27, new Integer(1), 0);
                        ...
                        if (TL18Condition == 1){TL32.setTrafficLightCondition(3);}
                        else if (TL18Condition == 2){TL32.setTrafficLightCondition(1);}
                        else{TL32.setTrafficLightCondition(1);}
                        TL32.setBounds(290, 330+210, 20, 50);
                        lpane.add(TL29, new Integer(1), 0);
                        lpane.add(TL30, new Integer(1), 0);
                        lpane.add(TL31, new Integer(1), 0);
                        ...
                        if (TL19Condition == 1){TL36.setTrafficLightCondition(3);}
                        else if (TL19Condition == 2){TL36.setTrafficLightCondition(1);}
                        else{TL36.setTrafficLightCondition(1);}
                        TL36.setBounds(290+210, 330+210, 20, 50);
                        lpane.add(TL33, new Integer(1), 0);
                        lpane.add(TL34, new Integer(1), 0);
                        lpane.add(TL35, new Integer(1), 0);
